...
declare global {
  interface Window {
    __lumioGalleryApp?: App
    bootstrapGalleryApp?: () => App
  }
}

export function bootstrapGalleryApp() {
  if (window.__lumioGalleryApp) return window.__lumioGalleryApp
  window.__lumioGalleryApp = new App()
  return window.__lumioGalleryApp
}

window.bootstrapGalleryApp = bootstrapGalleryApp
